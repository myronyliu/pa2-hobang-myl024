...
gflops_h, double t_d, double gflops_d, int do_host, int prefer_l1, int
use_rand, int use_bt)
{
    ...
    printf("@ %5d  %4d   %4d    %3d   %8.2e  %6.1f  %8.2e %6.1f     %1c    %1c    %1c    %1c\n\n",n,ntx, nty,reps,t_h,gflops_h,t_d,gflops_d, DoHost, PreferL1, UseRand, UseBT);
}
